...
# Install programs
sudo apt update &&
sudo apt install -y nautilus-dropbox virtualbox chromium-browser keepassx unity-tweak-tool htop powertop ubuntu-restricted-extras pepperflashplugin-nonfree tlp ubuntu-make git synapse albert dconf-editor nodejs-legacy &&
